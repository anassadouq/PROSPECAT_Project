    ...
    render(){
        return(
            <div className="row my-5">
                <div className="col-8">
                    <h1 className="my-3" id="title2">Find emails</h1>
                    <p className="text-secondary" id="paragraphe">Having a lead's name and current company, you can get his business email address in a second.</p>
                        <Link to="/features">
