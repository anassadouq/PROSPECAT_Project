            ...
            <div className="row my-5">
                <div className="col-7">
                    ...
                    <p className="text-secondary" id="prg2">Prospecat is a B2B prospecting platform. Use it to <br/>find email addresses and build a quality B2B Data <br/>for your sales funnel.</p>
                        <Link to="/features">
                            <button className="btn rounded-pill my-2" id="btn_Leads1">Get started Now For Free</button>
                        </Link>
                        <button className="mx-3 btn rounded-pill" id="btn_Leads2">Get Chrome Extension</button>
                </div>
                <div className="col-4">
